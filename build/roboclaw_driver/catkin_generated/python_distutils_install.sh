...
echo_and_run cd "/home/joel/encoder_publisher_ws/src/roboclaw_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/joel/encoder_publisher_ws/src/roboclaw_driver/setup.py" \
     \
    build --build-base "/home/joel/encoder_publisher_ws/build/roboclaw_driver" \
    install \
    --root="${DESTDIR-/}" \
